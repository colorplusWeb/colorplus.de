...
jQuery(document).ready(function ($) {
  ...
  var win = $(window),
    ...
    loaderIntro =
      '<div class="landing landing-slider"><div class="spinner"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></div>',
    loader =
      '<div class="landing landing-els"><div class="spinner"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></div>',
    loaderLightbox =
      '<div class="landing landing-els lightbox"><div class="spinner"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></div>',
    darkover = '<div class="darkover"></div>',
    moreBtnIcon =
      '<div class="more"><a href="#main"><i class="icon icon-arrow-down"></i></a></div>';
    ...
    if (pxWrapper.length) {
      ...
      if (touchDevice) {
        ...
        pxImgCaption.each(function () {
          ...
          $this.css({
            top:
              (pxWrapper.height() + headerHeight / 2 - $this.outerHeight()) / 2,
          });
        });
        ...
        if (touchDevice) {
          ...
          pxContainer.attr(
            "data-top-bottom",
            "transform:translateY(" + "-" + pxWrapper.height() / 4 + "px);"
          );
          header.attr(
            "data-top-bottom",
            "transform:translateY(" + "-" + pxWrapper.height() / 4 + "px);"
          ...
          .init({
            ...
            render: function () {
              if (header.hasClass("skrollable-after")) {
                ...
                animDone = false;
                header.removeClass("fixed-header").css({
                  padding: "2rem 0",
                });
              }
            },
        ...
        pxImgCaption.each(function () {
          ...
          if (!body.hasClass("mobile") && body.hasClass("no-parallax")) {
            $this.css({
              top:
                (pxWrapper.height() + headerHeight - $this.outerHeight()) / 2,
            });
          } else {
            $this.css({
  ...
  var menuToggle = $("#menu-toggle"),
    ...
    menuArrow =
      '<span class="sub-arrow"><i class="fa fa-chevron-down"></i></span>';
  ...
  menuToggle.click(function () {
    ...
    $(this).parent(".nav-inner").toggleClass("active");
    ...
    lightboxContainer.each(function () {
      ...
      var activityIndicatorOn = function () {
        ...
        closeButtonOn = function (instance) {
          $(
            '<a href="#" id="imagelightbox-close"><i class="icon icon-close"></i></a>'
          )
            .appendTo("body")
            .on("click", function () {
              $(this).remove();
        ...
        captionOn = function () {
          ...
          if (description.length > 0)
            $(
              '<div id="imagelightbox-caption"><h3>' +
                description +
                "</h3></div>"
            ).appendTo("body");
        },
      ...
      var instance = $this
        .find('.item a[data-lightbox^="gallery-"]')
        .imageLightbox({
          onStart: function () {
            overlayOn();
